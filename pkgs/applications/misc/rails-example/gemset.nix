{
  ...
  unicorn = {
    ...
    source = {
      type = "gem";
      remotes = ["https://rubygems.org"];
      sha256 = "07287i3qbig1rj3ay1f5j233zjzh0kc38242dz2q8hxmfcif3alj";
    };
  };
  uglifier = {
    version = "2.7.2";
  ...
  sprockets = {
    ...
    source = {
      type = "gem";
      remotes = ["https://rubygems.org"];
      sha256 = "084prmb1paxh3yggb70l9a8a83svj6qss1rpp1x24l55n3fd4xbq";
    };
  };
  spring = {
    version = "1.6.4";
  ...
  sass = {
    ...
    source = {
      type = "gem";
      remotes = ["https://rubygems.org"];
      sha256 = "1lkka6xpmsrn0bsg97kr575w5zpwpvq5yacq689y0mny7fp0gy85";
    };
  };
  rdoc = {
    version = "4.2.2";
  ...
  rake = {
    ...
    source = {
      type = "gem";
      remotes = ["https://rubygems.org"];
      sha256 = "1npy82ixqcr288zi2cbl35jdk4mbhcsf33ziwxydid1fizkh5jf4";
    };
  };
  raindrops = {
    version = "0.16.0";
    source = {
      type = "gem";
      remotes = ["https://rubygems.org"];
      sha256 = "1rmnfvyijgq7a617wv7mvdij90mz083jh2931nvmlmw5i8kaxpal";
    };
  };
  railties = {
    version = "4.2.5";
  ...
  jquery-rails = {
    ...
    source = {
      type = "gem";
      remotes = ["https://rubygems.org"];
      sha256 = "1rd9cv0mzmjvvvbz0z444c4zzr6vh0jk0qfmbj8v7yrs3xp460vx";
    };
  };
  jbuilder = {
    version = "2.4.1";
  ...
  byebug = {
    ...
    source = {
      type = "gem";
      remotes = ["https://rubygems.org"];
      sha256 = "0fpzgx2kvlkr9p5m6n5jklxd2l12dbrsg6ix6504aanx4b4sfahy";
    };
  };
  builder = {
    version = "3.2.2";
